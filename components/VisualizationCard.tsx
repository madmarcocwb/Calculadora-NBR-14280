  ...
  return (
    <div id="chart-section" className="bg-white p-8 rounded-3xl shadow-sm border border-slate-200 transition-all relative">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <button 
          onClick={handlePrint}
          className="no-print bg-slate-100 text-[#00008B] p-3 rounded-2xl hover:bg-slate-200 transition-all active:scale-95 flex items-center gap-2 font-black text-xs uppercase tracking-widest border border-slate-200 shadow-sm"
